// Filename: FmsRpQA.cxx
// Description: Look at various RP and FMS variable distributions.
...
void FmsRpQA(Int_t runNo, Int_t maxFiles)
{
    ...
    TString fileName = "FmsRpQA.root";
    TFile *file = new TFile(fileName, "recreate", "RP Track variable distributions from run");
