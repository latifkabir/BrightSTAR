...
// Description: Fms-Rp correlations for polarized proton break up
...
void AnFmsRpCorrPpb(Int_t firstRun, Int_t lastRun, TString outName, TString inFilePrefix)
{    
	...
	for(Int_t evt = 0; evt < nEntries; ++evt)
	{
	    ...
	    if(!(event->GetBbcSumSmall(1) > 0))	//bbc 0 is east and 1 is west 
		continue;
	    ...
	    if(event->GetBbcSumLarge(0) > 110) //bbc 0 is east and 1 is west 
		continue;
