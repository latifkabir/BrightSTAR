// Filename: AnEEmcRpCorrMergedFullPpb.C
// Description: 
...
void AnEEmcRpCorrMergedFullPpb(TString dirPath, Int_t maxEvents)
{
    ...
    TFile *fout = new TFile("EEmcRpCorrPpb.root", "RECREATE");
	...
	if(!(reader->evt_bbcADCSum[1] > 0))  //bbc 0 is east and 1 is west 
	    continue;
	...
	if(reader->evt_bbcADCSumLarge[0] > 10)  //bbc 0 is east and 1 is west 
	    continue;
	...
	hist23->Fill(pionM);
	hist24->Fill(pionE);
	hist25->Fill(reader->rp_trackP[eastTrk_i]);
