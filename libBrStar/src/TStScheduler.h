...
public:
    ...
    static void SubmitJob(TString functionName, Int_t firstRun,  Int_t lastRunOrNfiles = -1, TString outName = "", TString jobName = "condor");    // Submit job using star template scheduler
    static void SubmitJob(TString functionName, TString inFileName, TString outName = "", TString jobName = "condor");    // Sumit Job using SUMS
