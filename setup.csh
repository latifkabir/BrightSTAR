...
setenv LD_LIBRARY_PATH "${LD_LIBRARY_PATH}:${STARHOME}:${STARHOME}/libBrStar/lib:${STARHOME}/analysis/lib:${STARHOME}/runMacros/lib:${STARHOME}/diffAnalysis/lib:$STARHOME/emJetAnalysis/lib:$STARHOME/cepAnalysis/lib:${STARHOME}/.sl73_gcc485/lib"
