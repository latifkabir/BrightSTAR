// $Id: StFmsEtFilterMaker.h,v 1.1 2018/05/22 19:55:42 akio Exp $

#ifndef STAR_StFmsEtFilterMaker
#define STAR_StFmsEtFilterMaker

/*!
 *                                                                     
 * \class  StFmsEtFilterMaker
 * \author Jan Balewski
 * \date   April 2008
...
class StFmsEtFilterMaker : public StMaker {
 private:
 ...
 public: 
  ...
  StFmsEtFilterMaker(const char *name="FmsFilter");
  virtual       ~StFmsEtFilterMaker();
  virtual Int_t Init();
  virtual Int_t  Make();
  ...
  virtual const char *GetCVS() const {
    static const char cvs[]="Tag $Name:  $ $Id: StFmsEtFilterMaker.h,v 1.1 2018/05/22 19:55:42 akio Exp $ built " __DATE__ " " __TIME__ ; 
    return cvs;
  }

  ClassDef(StFmsEtFilterMaker,0)  
};
...
/* ===================================
  ...
  StFmsEtFilterMaker *eeFlt1Mk=new StFmsEtFilterMaker("FmsFilterPreTPC"); 
  eeFlt1Mk->setEtThres(14.);// (GeV), event-eta used 
  eeFlt1Mk->setFixedVertex(-60.); // (cm), Z0

  //  this filter-2 requires reco vertex
  StFmsEtFilterMaker *eeFlt2Mk=new StFmsEtFilterMaker("FmsFilterPostTPC"); 
