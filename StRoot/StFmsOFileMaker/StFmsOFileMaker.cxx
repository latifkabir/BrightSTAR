...
Int_t StFmsOFileMaker::Init() {  
  ...
  */
  ...
  p_out->Branch("bbcADCSum",bbcADCSum,"bbcADCSum[2]/s"); // sum of BBC ADC for small tiles [0=east,1=west]
  p_out->Branch("bbcADCSumLarge",bbcADCSumLarge,"bbcADCSumLarge[2]/s"); // sum of BBC ADC for large tiles [0=east,1=west]
  p_out->Branch("bbcEarliestTDC",bbcEarliestTDC,"bbcEarliestTDC[2]/s"); // earlist BBC TDC (small tiles)
  p_out->Branch("bbcEarliestTDCLarge",bbcEarliestTDCLarge,"bbcEarliestTDCLarge[2]/s"); // earlist BBC TDC (large tiles)
