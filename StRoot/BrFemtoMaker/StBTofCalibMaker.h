/*******************************************************************
 *
 * $Id: StBTofCalibMaker.h,v 1.1 2019/06/05 18:37:10 jdb Exp $
 *
 * Author: Xin Dong
 *****************************************************************
 *
 ...
 * Revision 1.1  2019/06/05 18:37:10  jdb
 * Added the FemtoMaker
 *
...
private:
  ...
  static const Double_t mC_Light;  // = C_C_LIGHT/1.e9;
    ...
    virtual const char *GetCVS() const 
      {static const char cvs[]="Tag $Name:  $ $Id: StBTofCalibMaker.h,v 1.1 2019/06/05 18:37:10 jdb Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
