...
void EjAnalysisTreeQa(TString inFileName, TString outName, TString det)
{
    ...
    TH1D *h1E = new TH1D ("h1E", "EM Jet E; Jet E [GeV]", 200, 0.0, EjAna::kFmsEngMax);
    TH1D *h1JetE_s = new TH1D ("h1JetE_s", "EM Jet E [small cells]; Jet E [GeV]", 200, 0.0, EjAna::kFmsEngMax);
    TH1D *h1JetE_l = new TH1D ("h1JetE_l", "EM Jet E [large cells]; Jet E [GeV]", 200, 0.0, EjAna::kFmsEngMax);    
