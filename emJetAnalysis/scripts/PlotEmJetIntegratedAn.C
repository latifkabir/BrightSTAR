// Filename: PlotEmJetIntegratedAn.C
// Description: 
// Author: Latif Kabir < kabir@bnl.gov >
// Created: Mon Aug 16 12:04:11 2021 (-0400)
// URL: jlab.org/~latif

void PlotEmJetIntegratedAn()
{
    ...
    TGraphErrors* gr1Ph = f1Ph->Get("An2Photons"); //1 photon case was saved as 2 photon. Do not be confused about name
    gr1Ph->SetName("An1Photon");
    TGraphErrors* gr2Ph = f2And3Ph->Get("An2Photons");
    TGraphErrors* gr3PhOrMore = f2And3Ph->Get("AnNphotons");
    ...
    TGraphErrors *gr1Ph_sys = gr1Ph->Clone("An1Photon_sys");
    TGraphErrors *gr2Ph_sys = gr2Ph->Clone("An2Photons_sys");
    TGraphErrors *gr3PhOrMore_sys = gr3PhOrMore->Clone("AnNphotons_sys");
	...
	gr1Ph_sys->SetPointError(i, x*0.03, y*0.35);
    }
