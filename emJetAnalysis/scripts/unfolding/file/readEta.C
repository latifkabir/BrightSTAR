...
int d(int case1  =0){
  ...
  if(case1==1)  infile.open("jEta-le2ph/xf2/case.txt");
  if(case1==2)  infile.open("jEta-ge3ph/xf2/case.txt");

  if(case1==3)  infile.open("jEta-le2ph-C/xf2/case.txt");
  if(case1==4)  infile.open("jEta-ge3ph-C/xf2/case.txt");
 ...
 c->cd(case1-2);
   ...
   ptAn1->SetMarkerColor(4);
  ptAn1->SetLineColor(4);
  ptAn1->SetMarkerSize(1.2);
 ptAn1->SetMarkerStyle(20);
 ptAn1->GetYaxis()->SetRangeUser(-.01,.07);

  ptAn2->SetLineColor(4);
  ptAn3->SetLineColor(4);
  ptAn4->SetLineColor(4);
