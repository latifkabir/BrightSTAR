...
void JetQA(TChain *jetChain, TChain *skimChain, TString outfile, Int_t nentries)
{
	...
	// JP1 trigger
	StJetSkimTrig* trigJP1 = skimEvent->trigger(480414);
	if (!trigJP1) trigJP1 = skimEvent->trigger(480414);
	//JP2 trigger
	StJetSkimTrig* trigJP2 = skimEvent->trigger(480411);
	if (!trigJP2) trigJP2 = skimEvent->trigger(480411);
	//EHT0 trigger (Testing)
	StJetSkimTrig* trigBHT3 = skimEvent->trigger(480301);
	if (!trigBHT3) trigBHT3 = skimEvent->trigger(480301);
	//BBCMB trigger (Testing)
	StJetSkimTrig* trigAJP = skimEvent->trigger(480003);
	if (!trigAJP) trigAJP = skimEvent->trigger(480003);
