...
//-- Converted to compilable script -- Latif Kabir
		      ...
		      
{
	...
	mEEmixer->sector(i);
    //<--- Disabled Trigger seelction --->
    //mEEmixer->trigger(trigID); // specify trigger id(s) to process 

 
    //pi0 analysis starts
    StEEmcIUPi0Analysis *mEEpi0analysis = new StEEmcIUPi0Analysis("pi0analy");
    //<--- Disabled Trigger seelction --->
