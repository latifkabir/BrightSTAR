// This script  based on StRoot/StPiDstMaker/macro/genDst.C
...
const char* defaultOptions = "picoDst,PicoVtxMode:PicoVtxVpdOrDefault,TpcVpdVzDiffCut:6,PicoCovMtxMode:PicoCovMtxWrite:PicoBEmcSmdWrite";
