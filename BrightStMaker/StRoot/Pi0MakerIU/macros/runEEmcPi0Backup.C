		      ...
		      
{
  //home/starreco/reco/ppProductionLong/FullField/P06ie/2006/136/7136033/st_physics_adc_7136033_raw_1060001.MuDst.root
    //get_file_list.pl -keys 'path,filename,events' -cond 'trgsetupname=ppProductionLong, production=P06ie,storage=hpss,filetype=daq_reco_mudst,filename~st_physics_adc_7136033_raw_' -delim '/'   
