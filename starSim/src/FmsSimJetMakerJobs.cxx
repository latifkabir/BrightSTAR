...
{    
	...
	TString muDstName = inFilePrefix + Form("%i_", i) + "500evts.MuDst.root";
	TString pyName = inFilePrefix + Form("%i_", i) + "500evts.pythia.root";
	TString outName = "FmsJetSim_500evts_pass0";
