...
void RunFmsJetFinderGenVsRec(TString inMuDstFile, TString outJetName, Int_t nEvents)
{
    ...
    TString ueFileName = "ue_" + outJetName;
    TString skimFileName = "skim_" + outJetName;
