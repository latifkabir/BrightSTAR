...
void EEmcSimRunBfc(int cycle, int nevents, int filterThreshold, int filterThreshold = 12)
{
    EEmcSimRunBfc(-1, Form("EEmcSim_Run15_%i_evt%i.fzd", cycle, nevents), filterThreshold);     
}
