...
#include "bfc.C"
#include "StSpinPool/StFmsFilterMaker/StFmsFilterMaker.h"
...
void FmsSimRunBfc(int nevents, const char* fzfile) 
{
    ...
    //gROOT->LoadMacro("bfc.C");  //This is how everyone else in STAR does it. bfc.C is under ROOT macros path in that case
    ...
    //StFmsTriggerMaker --------> Use in RunJetMaker
